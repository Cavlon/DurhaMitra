    ...
    <div class="border-bottom">
        ...
        <div class="d-flex text-muted pt-3">
          ...
          <p class="pb-3 mb-0 small lh-sm">
            <!--Username-->
            <button class="navbar-toggler d-block" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbarDark" aria-controls="offcanvasNavbarDark">
              <strong class="d-block text-gray-dark highlight">@${post.name}</strong>
            </button>
            <!--Post Text-->
            ${post.text}
          </p>
        ...
        <div class="text-muted">
          <p class="pt-2 mb-0 small lh-sm">
            ...
            <div class="collapsible">
              <div class="card-footer pt-3 border-0" style="background-color: #f8f9fa; padding-bottom: 55px;">
                <div class="d-flex flex-start w-100">
                  ...
                  <!--Comment Text Area-->
                    <textarea class="form-control" id="commentText" rows="2"
                      style="background: #fff;" placeholder="Add a comment..."></textarea>
                  </div>
                </div>
                <div class="float-end mt-2 pt-1" style="padding-right: 10px;">
        ...
        <div class="d-flex text-muted" style="padding-left: 30px;">
          <!--Profile Pic-->
          ...
          <p class="pb-3 pt-1 mb-0 lh-1" style="font-size:.8em">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasNavbarDark" aria-controls="offcanvasNavbarDark">
              <strong class="d-block text-gray-dark highlight">@Cavlon</strong>
            </button>
            <!--Post Text-->
            Those are sick!!!!!11!
          </p>
